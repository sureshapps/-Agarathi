...
export default function TamilDictionaryApp() {
  ...
  <div class="relative">
    ...
    <div class="relative leading-none tracking-tight text-5xl font-extrabold py-4 px-15 bg-white border border-gray-500 rounded-xl transform hover:translate-y-1 transition duration-150">தமிழ் அகராதி</div>
